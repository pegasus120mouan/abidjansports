<?php $__env->startSection('title', 'Boutique - Abidjansports'); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <?php $__currentLoopData = $journals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $journal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition group">
                    <a href="<?php echo e(route('journal.show', $journal['slug'])); ?>" class="block">
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-gray-500 text-sm mb-3"><?php echo e($journal['date_publication_formatte']); ?></p>
                        
                        <div class="flex items-center justify-between">
                            <span class="text-orange-600 font-bold text-lg"><?php echo e($journal['prix_formatte']); ?></span>
                            
                            <?php if($journal['disponible']): ?>
                                <a href="<?php echo e(route('journal.show', $journal['slug'])); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\abidjansports\resources\views/boutique.blade.php ENDPATH**/ ?>