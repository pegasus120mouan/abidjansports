<?php $__env->startSection('title', $journal['titre'] . ' - Boutique Abidjansports'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <nav class="mb-6">
        <ol class="flex items-center gap-2 text-sm text-gray-600">
            <li><a href="<?php echo e(route('home')); ?>" class="hover:text-orange-600">Accueil</a></li>
            <li><span class="text-gray-400">/</span></li>
            <li><a href="<?php echo e(route('boutique')); ?>" class="hover:text-orange-600">Boutique</a></li>
            <li><span class="text-gray-400">/</span></li>
            <li class="text-orange-600 font-semibold"><?php echo e($journal['titre']); ?></li>
        </ol>
    </nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="grid md:grid-cols-2 gap-6 p-6">
                    ...
                    <div class="aspect-[3/4] rounded-lg overflow-hidden bg-gray-100">
                        <?php if($journal['image']): ?>
                            <img src="<?php echo e(\App\Helpers\HtmlHelper::proxyImageUrl($journal['image'])); ?>" 
                                 alt="<?php echo e($journal['titre']); ?>" 
                    ...
                    <div class="flex flex-col">
                        ...
                        <?php if($journal['description']): ?>
                            <div class="text-gray-700 mb-6 flex-1">
                                ...
                                <p><?php echo e($journal['description']); ?></p>
                            </div>
                        <?php endif; ?>

                        <div class="space-y-3 mt-auto">
                            <?php if($journal['disponible']): ?>
                                <div class="flex items-center gap-2 text-green-600">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="font-semibold">En stock (<?php echo e($journal['stock']); ?> disponibles)</span>
                                </div>

                                <a href="https://wa.me/2250700000000?text=Bonjour, je souhaite commander le journal: <?php echo e(urlencode($journal['titre'])); ?>" 
                                   target="_blank"
                            ...
                            <?php if($journal['fichier_pdf']): ?>
                                <a href="<?php echo e($journal['fichier_pdf']); ?>" 
                                   target="_blank"
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $latestJournals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php if($item['slug'] !== $journal['slug']): ?>
                            <a href="<?php echo e(route('journal.show', $item['slug'])); ?>" class="flex gap-3 group">
                                <div class="w-16 h-20 rounded-lg overflow-hidden shrink-0 bg-gray-100">
                                    <?php if($item['image']): ?>
                                        <img src="<?php echo e(\App\Helpers\HtmlHelper::proxyImageUrl($item['image'])); ?>" alt="<?php echo e($item['titre']); ?>" class="w-full h-full object-cover">
                                    <?php else: ?>
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-orange-600 font-bold text-sm mt-1"><?php echo e($item['prix_formatte']); ?></p>
                                </div>
                            </a>
                        <?php endif; ?>
                ...
                <a href="<?php echo e(route('boutique')); ?>" class="block text-center text-orange-600 hover:text-orange-700 font-semibold mt-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\abidjansports\resources\views/journal-detail.blade.php ENDPATH**/ ?>